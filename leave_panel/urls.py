...
from leave.views import department,leave_type, leaves, employees, user,admin as adminoops
...
urlpatterns = [
    ...
    path('izin-turleri/<int:pk>/duzenle/', leave_type.edit_leave_type, name='edit_leave_type'),
    path('izin-turleri/<int:pk>/sil/', leave_type.delete_leave_type, name='delete_leave_type'),
    ...
    path('departman/<int:pk>/duzenle/', department.edit_department, name='edit_department'),
    path('departman/<int:pk>/sil/', department.delete_department, name='delete_department'),
    ...
    path('calisan/<int:pk>/duzenle/', employees.update_employee, name='update_employee'),
]
